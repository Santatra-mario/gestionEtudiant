...
export const useNotification = () => {
  ...
  const success = useCallback(
    (message) => showNotification(message, "success", 4000),
    [showNotification],
  );
  const error = useCallback(
    (message) => showNotification(message, "danger", 5000),
    [showNotification],
  );
  const warning = useCallback(
    (message) => showNotification(message, "warning", 4000),
    [showNotification],
  );
  const info = useCallback(
    (message) => showNotification(message, "info", 3500),
    [showNotification],
  );
