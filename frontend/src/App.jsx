  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<PrivateRoute><Layout /></PrivateRoute>}>
        ...
        <Route path="filieres" element={<PrivateRoute roles={['administrateur']}><FilieresPage /></PrivateRoute>} />
        <Route path="utilisateurs" element={<PrivateRoute roles={['administrateur']}><UtilisateursPage /></PrivateRoute>} />
      </Route>
