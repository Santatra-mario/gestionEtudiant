...
export default function NotesPage() {
  ...
  // --- GÉNÉRATION DU PDF STYLISÉ (tableau) ---
  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 20, maxWidth: 500 }} className="no-print">
        {inscLoading ? (
          <Spinner />
        ) : (
          <Select
      ...
      {bulletin && !loading && (
        <div className="print-area">
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            {msg.text && (
              <Alert type={msg.type === "success" ? "success" : "danger"} className="no-print">
                {msg.text}
              </Alert>
            )}
