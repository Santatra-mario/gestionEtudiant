...
const ROLE_CONFIG = {
  administrateur: {
    ...
    gradient: "linear-gradient(135deg, #4f8ef7, #2d6ee0)",
  },
  secretaire: {
    color: "#22c55e",
  ...
  return (
    ...
    >
        ...
        <div style={{ position: "relative", flexShrink: 0 }}>
          <div
            style={{
              ...
              borderRadius: 10,
              background:
                "linear-gradient(135deg, rgba(var(--accent-rgb), 0.25) 0%, rgba(var(--accent-rgb), 0.08) 100%)",
      ...
      <button
        ...
        aria-label={
          collapsed
            ? "Agrandir le menu de navigation"
            : "Réduire le menu de navigation"
        }
        style={{
          width: 28,
          height: 28,
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        >
          ...
          <span
            style={{ color: "var(--border)", fontSize: 15, fontWeight: 300 }}
          >
            /
          </span>
